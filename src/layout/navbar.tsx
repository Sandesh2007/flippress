    ...
    <nav className="glass w-full shadow-soft">
      ...
      <div className="flex items-center justify-between w-full px-3 sm:px-6 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          <Link
            href={homePage}
            className="flex gap-2 sm:gap-3 items-center flex-shrink-0 group"
          >
            <div className="relative">
              <Image
                ...
                height={36}
                width={36}
                className="sm:h-12 sm:w-12 transition-transform duration-300 group-hover:scale-110"
                priority
              />
            </div>
            <div className="flex flex-col">
              <span className="font-bold text-lg sm:text-xl text-blue-500">
                Flippress
              </span>
          ...
          <div className="flex items-center gap-1">
            ...
            {user ? (
              <div className="flex items-center gap-2 xl:gap-3">
                <Link
                  href="/profile"
                  className="flex items-center gap-2 hover:scale-105 transition-all duration-300 rounded-xl p-2 glass"
                >
                  <CurrentUserAvatar />
                </Link>
              </div>
              ...
              <>
                ...
                <Button
                  asChild
                  className="bg-primary hover:shadow-glow text-white text-sm font-medium px-4 xl:px-6 py-2 rounded-xl transition-all duration-300 hover:scale-105 group"
                >
        ...
        <div className="flex items-center gap-2 sm:gap-3 lg:hidden">
          ...
          {user && (
            <Link
              href="/profile"
              className="flex items-center gap-2 p-1.5 sm:p-2 rounded-xl hover:bg-accent transition-all duration-300"
      ...
      {(mobileOpen || isAnimating) && (
        <div className="fixed inset-0 z-[9999] h-screen">
          ...
          <div
            ref={menuRef}
            className={`fixed inset-0 w-screen h-screen bg-neutral-50 dark:bg-neutral-800 shadow-2xl transform transition-all duration-300 ease-out ${
              isAnimating
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-border/50 flex-shrink-0">
              ...
              >
                ...
                <div className="flex flex-col min-w-0">
                  <span className="font-bold text-base sm:text-lg text-blue-500 truncate">
                    Flippress
                  </span>
            ...
            <div className="flex flex-col flex-1 min-h-0">
              ...
              <div className="w-full px-4 sm:px-6 py-4 self-start sm:py-6 border-t border-border/50 flex-shrink-0">
                ...
                <Link
                  href="/pricing"
                  className="block px-4 py-3 rounded-xl hover:bg-accent/50 transition-all duration-300 text-sm mb-4"
                  onClick={handleCloseMenu}
                >
                  Pricing
                </Link>
                {user ? (
                  <Link
                    href="/profile"
                    className="flex items-center gap-4 px-4 py-3 bg-primary/20 rounded-xl transition-all duration-300"
                    onClick={handleCloseMenu}
                  >
                    <CurrentUserAvatar />
                  ...
                  <div className="space-y-3">
                    <Link
                      ...
                      className="block px-4 py-3 rounded-xl hover:bg-accent/50 transition-all duration-300 text-sm"
                      onClick={handleCloseMenu}
                    >
                      Login
                    </Link>
                    <Button
                      asChild
                      className="w-full bg-blue-500 hover:shadow-glow text-white text-sm font-medium rounded-xl transition-all duration-300 hover:scale-105"
                    >
                      <Link
                        href="/auth/register?mode=signup"
                        onClick={handleCloseMenu}
                      >
